...
bq. ri -Tf html String#gsub > gsub.html

...or to the Terminal using ANSI formatting

bq. ri -Tf ansi String#gsub

...took this off a part of "Why's Poignant Guide to Ruby":http://poignantguide.net/ruby/expansion-pak-1.html, hope to embelish this a bit further later.
