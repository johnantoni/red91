...
h4. Remote to your server + edit sources.list

Next remote into your server by using SSH at the prompt type,

bq. ssh root@mybox.com
...
bq. cd etc/apt<br />vi sources.list
...
bq. deb http://us.archive.ubuntu.com/ubuntu dapper universe<br />
...
bq. export PATH=/usr/local/sbin:/usr/local/bin:$PATH 
